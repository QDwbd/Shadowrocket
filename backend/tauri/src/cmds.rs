...
#[tauri::command]
pub async fn change_clash_core(clash_core: Option<shadowrocket::ClashCore>) -> CmdResult {
...
#[tauri::command]
pub async fn get_core_version(core_type: shadowrocket::ClashCore) -> CmdResult<String> {
...
#[tauri::command]
pub async fn update_core(core_type: shadowrocket::ClashCore) -> CmdResult {
    wrap_err!(
