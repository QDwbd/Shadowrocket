...
!macro CheckShadowrocketProcess Process ID
  !if "${INSTALLMODE}" == "currentUser"
...
!macro CheckAllShadowrocketProcesses
  !insertmacro CheckShadowrocketProcess "Shadowrocket.exe" "1"
  ; !insertmacro CheckShadowrocketProcess "clash-verge-service.exe" "2"
  !insertmacro CheckShadowrocketProcess "clash.exe" "3"
  !insertmacro CheckShadowrocketProcess "clash-rs.exe" "4"
  !insertmacro CheckShadowrocketProcess "mihomo.exe" "5"
  !insertmacro CheckShadowrocketProcess "mihomo-alpha.exe" "6"
!macroend

Section CheckProcesses
  !insertmacro CheckAllShadowrocketProcesses
SectionEnd
